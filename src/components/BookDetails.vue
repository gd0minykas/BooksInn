...
<template>
  <div class="row">
    <div class="col-12 justify-content-start mb-3">
      <button class="nav-link link-warning" @click="() => console.log('test')">
        <Back />
      </button>
    </div>
    <div class="col-4">
      <div class="d-flex justify-content-center m-3">
        ...
        <div
          ...
          style="width: 130px; height: 200px; background-color: #737163"
        >
    ...
    <div class="col-8">
      <div class="d-flex flex-column ms-4">
        ...
        <div v-for="authors in props.authors">
          <span class="ms-2">{{ authors }}</span>
        </div>
        <p class="mb-0">Categories:</p>
        <div v-for="categories in props.categories">
          <span class="ms-2">{{ categories }}</span>
        </div>
        <div>
          <span class="fs-5">"{{ props.pages }}"</span>
        </div>
      </div>
    </div>
