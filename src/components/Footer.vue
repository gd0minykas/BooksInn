...
<template>
  <footer id="footer" class="mt-5 footer mt-auto">
    <div class="container">
      <div class="row">
        <hr class="mt-3" />
        <div class="col">
        ...
        <div class="col">
          <div
            class="d-flex flex-row-reverse justify-content-evenly my-3 mx-5"
            v-if="!userState"
          >
          ...
          <div v-else class="d-flex flex-row-reverse my-3 mx-5">
